...
class ViewController: UIViewController {
    ...
    func matchColorLogic() -> Bool{
        ...
        if(buttonAnswer == 2){
            ...
            btnAnswer2OUTLET.setTitle(randColor3.colorName, forState: UIControlState.Normal)
    ...
    func changeColor(randColor: (colorName:String,hexValue:String,rgb:RGB,hsl:HSL,hsv:HSV)) -> Bool{
